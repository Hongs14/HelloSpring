...
public class LogAspect {
	@Pointcut(value="execution(* com.sample.myapp.aop2.sayHello(..))")
	public void helloPointcut() {}
	
	@Pointcut(value="execution(* com.sample.myapp.aop2.sayGoodbye(..))")
	...
	@Around("execution(* com.sample.myapp.aop2.*(..))")
